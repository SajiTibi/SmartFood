...
public class CookerMarkerAdapter extends RecyclerView.Adapter<CookerMarkerAdapter.ViewHolder> {
    ...
    @Override
    public com.awesome.food_app.smartfood.CookerMarkerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.cooker_marker_row, parent, false);

        return new com.awesome.food_app.smartfood.CookerMarkerAdapter.ViewHolder(view);
    }

    @SuppressLint("ClickableViewAccessibility")
    @Override
    public void onBindViewHolder(final com.awesome.food_app.smartfood.CookerMarkerAdapter.ViewHolder holder, int position) {
